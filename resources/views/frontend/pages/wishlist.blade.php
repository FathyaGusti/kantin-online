							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>Rp{{ number_format($wishlist['amount'] * $exchange_rate, 0, ',', '.') }}</span></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Tidak ada daftar keinginan yang tersedia. <a href="{{route('product-grids')}}" style="color:rgb(255, 0, 0);">Lanjutkan Membeli</a>
