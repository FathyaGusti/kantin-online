								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>Rp{{ number_format($cart['price'] * 15000, 0, ',', '.') }}</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money"><Rp>{$cart['amount'],0,',', '.'}</Rp>/span></td>
								...
								@else
										<tr>
											<td class="text-center">
												Tidak Ada Pesanan <a href="{{route('product-grids')}}" style="color:rgb(204, 7, 7);">Lihat Menu</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Total Pembayaran<span>Rp{{number_format($total_amount, 0, ',', '.')}}</span></li>
										@else
											<li class="last" id="order_total_price">Total Pembayaran<span>Rp{{number_format($total_amount, 0, ',', '.')}}</span></li>
										@endif
									</ul>
									<div class="button5">
										...
										<a href="{{route('product-grids')}}" class="btn">Pilih menu kembali</a>
									</div>
								</div>
							</div>
						</div>
	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				...
				let formattedTotal = formatRupiah(total.toFixed(2), 'Rp' );
				// alert(coupon);
				$('#order_total_price span'),text(formattedTotal);
			});
		});
